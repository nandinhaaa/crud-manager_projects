...
<body>
	...
	<div id="container" class="container-fluid">
		...
		<div id="top" class="row">
			...
			<div class="col-md-6">
				<div class="input-group h2">
					<input name="data[search]" class="form-control" id="search"
						type="text" placeholder="Pesquisar projetos"> <span
			...
			<div class="col-md-3">
				<a href="/crud-manager/project/form"
					class="btn btn-danger pull-right h2"><span
					class="glyphicon glyphicon-plus" /></span>&nbspAdicionar Projeto</a>
			</div>
		</div>
						...
						<c:forEach var="proj" items="${projects}">
							<tr>
								...
								<td class="actions"><a class="btn btn-info btn-xs"
									href="${pageContext.request.contextPath}/project/update?projectId=${proj.id}">
								...
								<td class="actions"><a
									...
									project-id="${proj.getId()}" project-name="${proj.getName()}"
