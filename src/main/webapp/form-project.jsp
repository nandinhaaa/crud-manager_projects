		...
		<form action="${pageContext.request.contextPath}/project/${action}" 
			...
			<div class="row">
				<div class="form-group col-md-6">
					...
					<input type="text" class="form-control" id="name" name="name" 
						   autofocus="autofocus" placeholder="Nome Projeto" 
						   required 
				...
				<div class="form-group col-md-6">
					<label for="role">Descrição</label>
					<input type="text" class="form-control" id="description" name="description" 
						   autofocus="autofocus" placeholder="Projeto utilizado" 
						   required 
			...
			<div id="actions" class="row pull-right">
				<div class="col-md-12">
					...
					<button type="submit" 
						    class="btn btn-primary">Cadastrar Projeto</button>
				</div>
			</div>
		</form>
